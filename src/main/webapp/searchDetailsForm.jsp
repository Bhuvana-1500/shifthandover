        ...
        if (date1 != null && name1 != null && !date1.isEmpty() && !name1.isEmpty()) {
            ...
            try {
                ...
                if (rs.isBeforeFirst()) { // Check if ResultSet is not empty
                    // Store results in request attribute to access in the redirected page
                    request.setAttribute("searchResults", rs);
                    // Redirect to another JSP to display the results
                    response.sendRedirect("displaySearchResults.jsp");
                } else {
